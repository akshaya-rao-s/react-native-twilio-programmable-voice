                ...
                if (BuildConfig.DEBUG) {
                    call.getStats(new StatsListener() {
                        ...
                        public void onStats(@NonNull List<StatsReport> statsReports) {
                            ...
                            Log.d(TAG, "Call stats: "+statsReports.toString());
                        }
                    });
                }
            }
...
//    }
    ...
    private class VoiceBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ACTION_INCOMING_CALL)) {
                ...
                // TODO check if implementation need something else
                clearIncomingNotification(activeCallInvite);
    ...
    private void clearIncomingNotification(CallInvite callInvite) {
        if (BuildConfig.DEBUG) {
            Log.d(TAG, "clearIncomingNotification() callInvite: "+ callInvite.toString());
        }
...
//            params.putString("call_to",    activeCallInvite.getTo());
//            // TODO fix this
//            // CallInvite.getState() has been removed in Twilio v3.0
